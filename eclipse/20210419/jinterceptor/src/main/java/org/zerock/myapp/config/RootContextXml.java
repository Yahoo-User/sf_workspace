...
//				new FileSystemResource("C:/opt/eclipse/workspace/jee/jinterceptor/src/main/resources/mybatis-config.xml");
		
		//-- 3rd. method
//		PathResource config = new PathResource("C:/opt/eclipse/workspace/jee/jinterceptor/src/main/resources/mybatis-config.xml");
